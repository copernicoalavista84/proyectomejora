...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '48px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '24px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#2a2a2a'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '34px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '72px', 'lineheight' => '72px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '26px', 'lineheight' => '26px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e8eef2'));
			...
			$options['latitude'] = array( 
								"name" => __("Latitude", CURRENT_THEME),
								"desc" => __("Latitude", CURRENT_THEME),
								"id" => "latitude",
								"std" => "34.4208333",
								"type" => "text");	

			$options['longitude'] = array( 
								"name" => __("Longitude", CURRENT_THEME),
								"desc" => __("Longitude", CURRENT_THEME),
								"id" => "longitude",
								"std" => "-119.6972222",
								"type" => "text");	

			$options['description'] = array( 
								"name" => __("Marker Description", CURRENT_THEME),
								"desc" => __("Marker Description. HTML tags are allowed.", CURRENT_THEME),
								"id" => "description",
								"std" => "<h6>Ut telloribus eget eleme</h6>
<p>Aean auctoetnaliir pis nteerutrulla fn nec ero ane ipsummis fau.</p>",
								"type" => "textarea");

			$options['zoom'] = array( 
								"name" => __("Zoom", CURRENT_THEME),
								"desc" => __("Zoom", CURRENT_THEME),
								"id" => "zoom",
								"std" => "13",
								"type" => "text");
