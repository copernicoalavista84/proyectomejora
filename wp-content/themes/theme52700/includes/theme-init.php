...
if ( !function_exists( 'cherry_child_setup' ) ) :
	...
	function cherry_child_setup() {
		...
		set_post_thumbnail_size( 370, 210, true ); // Normal post thumbnails
		add_image_size( 'slider-post-thumbnail', 1920, 706, true ); // Slider Thumbnail
