...
Tags: page builder, landing page, visual builder, visual editor, drag and drop
...
Drag and Drop frontend page builder for any theme. Build responsive sites visually without any code by using MotoPress website builder.

== Description ==

MotoPress Content Editor enhances the standard WordPress editor and enables you to build websites visually. It's a complete solution for creating responsive pages without coding - add content elements in clicks and move them around the page with drag and drop. MotoPress [Page Builder](https://motopress.com/products/content-editor/?utm_source=wp-org&utm_medium=textlink&utm_campaign=content-editor-lite&utm_content=motopress-page-builder) plugin is easily extendable, fully responsive and works smoothly with all WordPress themes.

MotoPress Content Editor is an unparalleled website builder for non-tech people and a professional tool for designers.

= How does MotoPress plugin work? =

[youtube https://www.youtube.com/watch?v=A1QKC1GBNLU]
[Watch on YouTube](https://www.youtube.com/watch?v=A1QKC1GBNLU)
For more videos visit our [channel](https://www.youtube.com/channel/UCtkDYmIQ5Lv_z8KbjJ2lpFQ)

[Check the Demo](https://mpcedemo.getmotopress.com/)

= Core features of MotoPress Content Editor =

= Real frontend editing for a perfect WYSIWYG experience. =
Leave a standard WordPress TinyMCE editor to customize the site fully on the frontend.

= Drag-and-drop and click-to-add options for easier page building. =
We've combined two techniques to make the editing process as much intuitive as possible - click to add sections, templates and elements and then change their position with drag and drop.

= Edit content for desktop, mobile and tablet devices in real time. =
In the mobile-first era, we've made the mobile editing a breeze: switch your editor to mobile or tablet mode, customize content and see the changes instantly.

= Native WordPress functionality integration. =
Edit page and post settings right in your visual builder without a need to go back and forth to the WordPress editor.

= Responsive and mobile ready layouts. =
Your website content built with MotoPress Page Builder is optimized for any viewport.

= Custom reusable widgets, sections and pages. =
Create, reuse and export your own pages to other websites. Do more in less time.

= Straightforward builder interface. =
Streamline the website building process with a handy toolkit of content elements and a thought-out builder layout.

= Fast-loading for more productive work. =
Design your pages really quickly and see the changes instantly.

= Revisions history. =
Check your changes and restore the needed page version at any time.

= Opportunity to extend functionality with free and premium addons. =

Add a pricing table, image hotspot, contact form, video slider and more useful functionality with easily integrated extensions.
Browse all [MotoPress Addons](https://motopress.com/products/category/content-editor-addons/?utm_source=wp-org&utm_medium=textlink&utm_campaign=content-editor-lite&utm_content=motopress-addons)

= No shortcode lock-in effect. =
Keep your content safe in a simplified version even after the plugin deactivation.
...
* Widgets area
* Member's content
* Multiple WordPress elements

= For more information visit =

* [Demo](https://mpcedemo.getmotopress.com/)
* [MotoPress website](https://motopress.com)
* [Documentation](https://motopress.com/documentation/wordpress/plugins/content-editor/)
* [Addons](https://motopress.com/products/category/content-editor-addons/)
* [Forums](https://motopress.com/forums/forum/wordpress/plugins/content-editor/)

= MotoPress Content Editor Pro =

Upgrade to [MotoPress Content Editor Pro](https://motopress.com/content-editor-lite-upgrade/) to have access to the following features:
* priority updates and support via tickets system
...
Read the [usage documentation](https://motopress.com/documentation/wordpress/plugins/) on the MotoPress website

== Frequently Asked Questions ==

Visit our [documentation page](https://motopress.com/documentation/wordpress/plugins/content-editor/) for more information on working with MotoPress Visual Builder. Please note that not all features described in the documentation are available in this version of the MotoPress Content Editor.


== Screenshots ==
1. Visual text editing
2. Element settings
3. Element styles
...
* Bug fix: fixed an issue with the Chart widget.
